 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getExactly <em>Exactly</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getAsname <em>Asname</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getPrev <em>Prev</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getSl <em>Sl</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.impl.TypescopeImpl#getPost <em>Post</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
