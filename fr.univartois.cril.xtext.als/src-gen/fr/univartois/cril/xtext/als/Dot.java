 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext.als.Dot#getDot <em>Dot</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext.als.AlsPackage#getDot()
 * @model
 * @generated
 */
public interface Dot extends EObject
{
   ...
   * @see #setDot(String)
   * @see fr.univartois.cril.xtext.als.AlsPackage#getDot_Dot()
   * @model
   * @generated
   */
  String getDot();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.Dot#getDot <em>Dot</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
