 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.alloyplugin.basics.impl.BlockImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockImpl extends ExpressionImpl implements Block
{
  ...
  {
    return BasicsPackage.Literals.BLOCK;
  }
  ...
  public EList<Expression> getExpr()
  {
    if (expr == null)
    {
      expr = new EObjectContainmentEList<Expression>(Expression.class, this, BasicsPackage.BLOCK__EXPR);
    }
    return expr;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BasicsPackage.BLOCK__EXPR:
