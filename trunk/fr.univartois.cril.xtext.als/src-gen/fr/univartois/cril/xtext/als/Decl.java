 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext.als.Decl#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.Decl#getComma <em>Comma</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.Decl#getColon <em>Colon</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.Decl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext.als.AlsPackage#getDecl()
 * @model
 * @generated
 */
public interface Decl extends EObject
{
   ...
   * The list contents are of type {@link fr.univartois.cril.xtext.als.PropertyName}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getDecl_PropertyName()
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getDecl_Comma()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setColon(Colon)
   * @see fr.univartois.cril.xtext.als.AlsPackage#getDecl_Colon()
   * @model containment="true"
   * @generated
   */
  Colon getColon();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.Decl#getColon <em>Colon</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getDecl_Expr()
   * @model containment="true"
   * @generated
   */
  Expression getExpr();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.Decl#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
