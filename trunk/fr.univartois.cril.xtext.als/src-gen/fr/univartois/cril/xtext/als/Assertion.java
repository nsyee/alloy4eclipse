 ...
 * </p>
 *
 * @see fr.univartois.cril.xtext.als.AlsPackage#getAssertion()
 * @model
 * @generated
 */
public interface Assertion extends Paragraph
{
   ...
   * @see #setBlock(Block)
   * @see fr.univartois.cril.xtext.als.AlsPackage#getAssertion_Block()
   * @model containment="true"
   * @generated
   */
  Block getBlock();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.Assertion#getBlock <em>Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
