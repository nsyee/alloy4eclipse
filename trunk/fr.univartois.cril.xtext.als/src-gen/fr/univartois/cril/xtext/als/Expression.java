...
public interface Expression extends EObject
{
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getExpression_Asname()
   * @model containment="true"
   * @generated
   */
  AsName getAsname();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.Expression#getAsname <em>Asname</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
