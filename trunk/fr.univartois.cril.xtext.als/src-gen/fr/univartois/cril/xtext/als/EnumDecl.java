 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext.als.EnumDecl#getEnumName <em>Enum Name</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.EnumDecl#getLeftC <em>Left C</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.EnumDecl#getPropertyEnum <em>Property Enum</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.EnumDecl#getComma <em>Comma</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext.als.EnumDecl#getRightC <em>Right C</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext.als.AlsPackage#getEnumDecl()
 * @model
 * @generated
 */
public interface EnumDecl extends Paragraph
{
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getEnumDecl_EnumName()
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.EnumDecl#getEnumName <em>Enum Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getEnumDecl_LeftC()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.EnumDecl#getLeftC <em>Left C</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link fr.univartois.cril.xtext.als.EnumPropertyName}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getEnumDecl_PropertyEnum()
   * @model containment="true"
   * @generated
   */
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getEnumDecl_Comma()
   * @model containment="true"
   * @generated
   */
   ...
   * @see fr.univartois.cril.xtext.als.AlsPackage#getEnumDecl_RightC()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext.als.EnumDecl#getRightC <em>Right C</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
