...
public class AbstractAlsSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_SigDecl_SigQualParserRuleCall_0_a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_SigDecl_SigQualParserRuleCall_0_a = new TokenAlias(true, true, grammarAccess.getSigDeclAccess().getSigQualParserRuleCall_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_SigDecl_SigQualParserRuleCall_0_a.equals(syntax))
				emit_SigDecl_SigQualParserRuleCall_0_a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     SigQual*
	 */
	protected void emit_SigDecl_SigQualParserRuleCall_0_a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	...
	/**
	 * Syntax:
	 *     (INT | NEGATIVE_INTEGER) | ('@'? 'int'? ('this' '/')? 'this')
	 */
