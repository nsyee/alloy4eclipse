...
public class AlsGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FunDeclElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cParamAssignment_4_0_1_0 = (Assignment)cGroup_4_0_1.eContents().get(0);
		private final RuleCall cParamParamParserRuleCall_4_0_1_0_0 = (RuleCall)cParamAssignment_4_0_1_0.eContents().get(0);
		...
		private final Assignment cParamAssignment_4_0_1_1_1 = (Assignment)cGroup_4_0_1_1.eContents().get(1);
		private final RuleCall cParamParamParserRuleCall_4_0_1_1_1_0 = (RuleCall)cParamAssignment_4_0_1_1_1.eContents().get(0);
		...
		//	"private"? "fun" (ref=Ref dot=Dot)? name=FunctionName (leftS=LeftSquareBracketKeyword (param+=Param (comma+=Comma
		//	param+=Param)*)? rightS=RightSquareBracketKeyword | leftP=LeftParenthesis (decl+=Decl (comma+=Comma decl+=Decl)*)?
		...
		//param+=Param
		public Assignment getParamAssignment_4_0_1_0() { return cParamAssignment_4_0_1_0; }

		//Param
		public RuleCall getParamParamParserRuleCall_4_0_1_0_0() { return cParamParamParserRuleCall_4_0_1_0_0; }
		...
		//param+=Param
		public Assignment getParamAssignment_4_0_1_1_1() { return cParamAssignment_4_0_1_1_1; }

		//Param
		public RuleCall getParamParamParserRuleCall_4_0_1_1_1_0() { return cParamParamParserRuleCall_4_0_1_1_1_0; }
	...
	public class PredDeclElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLeftPLeftParenthesisParserRuleCall_4_1_0_0 = (RuleCall)cLeftPAssignment_4_1_0.eContents().get(0);
		private final Group cGroup_4_1_1 = (Group)cGroup_4_1.eContents().get(1);
		private final Assignment cParamAssignment_4_1_1_0 = (Assignment)cGroup_4_1_1.eContents().get(0);
		private final RuleCall cParamParamParserRuleCall_4_1_1_0_0 = (RuleCall)cParamAssignment_4_1_1_0.eContents().get(0);
		private final Group cGroup_4_1_1_1 = (Group)cGroup_4_1_1.eContents().get(1);
		private final Assignment cCommaAssignment_4_1_1_1_0 = (Assignment)cGroup_4_1_1_1.eContents().get(0);
		private final RuleCall cCommaCommaParserRuleCall_4_1_1_1_0_0 = (RuleCall)cCommaAssignment_4_1_1_1_0.eContents().get(0);
		private final Assignment cParamAssignment_4_1_1_1_1 = (Assignment)cGroup_4_1_1_1.eContents().get(1);
		private final RuleCall cParamParamParserRuleCall_4_1_1_1_1_0 = (RuleCall)cParamAssignment_4_1_1_1_1.eContents().get(0);
		private final Assignment cRightPAssignment_4_1_2 = (Assignment)cGroup_4_1.eContents().get(2);
		private final RuleCall cRightPRightParenthesisParserRuleCall_4_1_2_0 = (RuleCall)cRightPAssignment_4_1_2.eContents().get(0);
		...
		//	"private"? "pred" (ref=Ref dot=Dot)? name=PredicateName (leftS=LeftSquareBracketKeyword (param+=Param (comma+=Comma
		...
		//param+=Param
		public Assignment getParamAssignment_4_1_1_0() { return cParamAssignment_4_1_1_0; }

		//Param
		public RuleCall getParamParamParserRuleCall_4_1_1_0_0() { return cParamParamParserRuleCall_4_1_1_0_0; }
		...
		//param+=Param
		public Assignment getParamAssignment_4_1_1_1_1() { return cParamAssignment_4_1_1_1_1; }

		//Param
		public RuleCall getParamParamParserRuleCall_4_1_1_1_1_0() { return cParamParamParserRuleCall_4_1_1_1_1_0; }
	...
	public class TerminalExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cExprAssignment_4_2_0 = (Assignment)cAlternatives_4_2.eContents().get(0);
		private final RuleCall cExprExpressionParserRuleCall_4_2_0_0 = (RuleCall)cExprAssignment_4_2_0.eContents().get(0);
		private final Group cGroup_4_2_1 = (Group)cAlternatives_4_2.eContents().get(1);
		private final Assignment cDeclAssignment_4_2_1_0 = (Assignment)cGroup_4_2_1.eContents().get(0);
		private final RuleCall cDeclDeclParserRuleCall_4_2_1_0_0 = (RuleCall)cDeclAssignment_4_2_1_0.eContents().get(0);
		private final Group cGroup_4_2_1_1 = (Group)cGroup_4_2_1.eContents().get(1);
		private final Assignment cCommaAssignment_4_2_1_1_0 = (Assignment)cGroup_4_2_1_1.eContents().get(0);
		private final RuleCall cCommaCommaParserRuleCall_4_2_1_1_0_0 = (RuleCall)cCommaAssignment_4_2_1_1_0.eContents().get(0);
		private final Assignment cDeclAssignment_4_2_1_1_1 = (Assignment)cGroup_4_2_1_1.eContents().get(1);
		private final RuleCall cDeclDeclParserRuleCall_4_2_1_1_1_0 = (RuleCall)cDeclAssignment_4_2_1_1_1.eContents().get(0);
		private final Assignment cBlockOrBarAssignment_4_3 = (Assignment)cGroup_4.eContents().get(3);
		private final RuleCall cBlockOrBarBlockOrBarParserRuleCall_4_3_0 = (RuleCall)cBlockOrBarAssignment_4_3.eContents().get(0);
		...
		//	unOp=UnOp expr+=Expression | {Expression} common+=CommonQuantUnOp (expr+=Expression | decl+=Decl (comma+=Comma
		//	decl+=Decl)*)? blockOrBar+=BlockOrBar | {Expression} INT | {Expression} NEGATIVE_INTEGER | {Expression} none="none" |
		//	{Expression} iden="iden" | {Expression} univ="univ" | {Expression} (int="int" nameRef=[ReferencesName]?) | int="Int" |
		//	{Expression} seq="seq/Int" | {Expression} "@"? "int"? ((asname=[AsName] | "this") "/")? (nameRef=[ReferencesName] |
		//	"this" | name="pred/totalOrder" | name=("fun/add" | "fun/sub" | "fun/mul" | "fun/div" | "fun/rem" | "fun/min" |
		//	"fun/max" | "fun/next")) | {Expression} block+=Block | {Expression} leftCurlyBracket=LeftCurlyBracket decl+=Decl
		//	(comma+=Comma decl+=Decl)* blockOrBar+=BlockOrBar rightCurlyBracket=RightCurlyBracket;
		public ParserRule getRule() { return rule; }
		...
		//{Expression} common+=CommonQuantUnOp (expr+=Expression | decl+=Decl (comma+=Comma decl+=Decl)*)? blockOrBar+=BlockOrBar
		...
		//(expr+=Expression | decl+=Decl (comma+=Comma decl+=Decl)*)?
		public Alternatives getAlternatives_4_2() { return cAlternatives_4_2; }

		//expr+=Expression
		public Assignment getExprAssignment_4_2_0() { return cExprAssignment_4_2_0; }

		//Expression
		public RuleCall getExprExpressionParserRuleCall_4_2_0_0() { return cExprExpressionParserRuleCall_4_2_0_0; }

		//decl+=Decl (comma+=Comma decl+=Decl)*
		public Group getGroup_4_2_1() { return cGroup_4_2_1; }

		//decl+=Decl
		public Assignment getDeclAssignment_4_2_1_0() { return cDeclAssignment_4_2_1_0; }

		//Decl
		public RuleCall getDeclDeclParserRuleCall_4_2_1_0_0() { return cDeclDeclParserRuleCall_4_2_1_0_0; }

		//(comma+=Comma decl+=Decl)*
		public Group getGroup_4_2_1_1() { return cGroup_4_2_1_1; }

		//comma+=Comma
		public Assignment getCommaAssignment_4_2_1_1_0() { return cCommaAssignment_4_2_1_1_0; }

		//Comma
		public RuleCall getCommaCommaParserRuleCall_4_2_1_1_0_0() { return cCommaCommaParserRuleCall_4_2_1_1_0_0; }

		//decl+=Decl
		public Assignment getDeclAssignment_4_2_1_1_1() { return cDeclAssignment_4_2_1_1_1; }

		//Decl
		public RuleCall getDeclDeclParserRuleCall_4_2_1_1_1_0() { return cDeclDeclParserRuleCall_4_2_1_1_1_0; }

		//blockOrBar+=BlockOrBar
		public Assignment getBlockOrBarAssignment_4_3() { return cBlockOrBarAssignment_4_3; }

		//BlockOrBar
		public RuleCall getBlockOrBarBlockOrBarParserRuleCall_4_3_0() { return cBlockOrBarBlockOrBarParserRuleCall_4_3_0; }
