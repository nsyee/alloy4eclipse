...
public class AlsFactoryImpl extends EFactoryImpl implements AlsFactory
{
  ...
  public static AlsFactory init()
  {
    try
    {
      AlsFactory theAlsFactory = (AlsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.univartois.fr/cril/xtext2/Als"); 
   ...
   * @generated
   */
  public BlockOrPossibleBar createBlockOrPossibleBar()
  {
    BlockOrPossibleBarImpl blockOrPossibleBar = new BlockOrPossibleBarImpl();
    return blockOrPossibleBar;
  }
