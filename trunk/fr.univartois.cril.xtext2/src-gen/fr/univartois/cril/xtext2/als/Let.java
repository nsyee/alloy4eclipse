 ...
 *   <li>{@link fr.univartois.cril.xtext2.als.Let#getComma <em>Comma</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Let#getRightS <em>Right S</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Let#getBlock <em>Block</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Let#getExprName <em>Expr Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet()
 * @model
 * @generated
 */
public interface Let extends Paragraph
{
   ...
   * @see #setName(LetName)
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_Name()
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Let#getName <em>Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_LeftS()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Let#getLeftS <em>Left S</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link fr.univartois.cril.xtext2.als.ReferencesName}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_NameRef()
   * @model containment="true"
   * @generated
   */
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_Comma()
   * @model containment="true"
   * @generated
   */
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_RightS()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Let#getRightS <em>Right S</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setBlock(Block)
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_Block()
   * @model containment="true"
   * @generated
   */
  Block getBlock();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Let#getBlock <em>Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getLet_ExprName()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Let#getExprName <em>Expr Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
