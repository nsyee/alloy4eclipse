 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.BinOp#getDot <em>Dot</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getBinOp()
 * @model
 * @generated
 */
public interface BinOp extends EObject
{
   ...
   * @see #setDot(Dot)
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getBinOp_Dot()
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.BinOp#getDot <em>Dot</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
