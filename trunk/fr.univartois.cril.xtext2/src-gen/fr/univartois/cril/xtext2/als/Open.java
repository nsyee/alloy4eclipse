 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.Open#getOpenName <em>Open Name</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Open#getLeft <em>Left</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Open#getPreviousNameAs <em>Previous Name As</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Open#getRefname <em>Refname</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Open#getRight <em>Right</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Open#getNameAs <em>Name As</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getOpen()
 * @model
 * @generated
 */
public interface Open extends EObject
{
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getOpen_OpenName()
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Open#getOpenName <em>Open Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getOpen_Left()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Open#getLeft <em>Left</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getOpen_PreviousNameAs()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Open#getPreviousNameAs <em>Previous Name As</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getOpen_Right()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Open#getRight <em>Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getOpen_NameAs()
   * @model containment="true"
   * @generated
   */
  AsName getNameAs();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Open#getNameAs <em>Name As</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
