 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getBinOp <em>Bin Op</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getCmp <em>Cmp</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getArrowOp <em>Arrow Op</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getPar <em>Par</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getComma <em>Comma</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getParO <em>Par O</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getParF <em>Par F</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getLet <em>Let</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getLetdecl <em>Letdecl</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getBlockOrBar <em>Block Or Bar</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getQuant <em>Quant</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getDecl <em>Decl</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getUnOp <em>Un Op</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getCommon <em>Common</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getNone <em>None</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getIden <em>Iden</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getUniv <em>Univ</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.impl.ExpressionImpl#getInt <em>Int</em>}</li>
