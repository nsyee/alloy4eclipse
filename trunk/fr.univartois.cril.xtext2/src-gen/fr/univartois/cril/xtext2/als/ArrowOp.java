 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.ArrowOp#getArrow <em>Arrow</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getArrowOp()
 * @model
 * @generated
 */
public interface ArrowOp extends EObject
{
   ...
   * @see #setArrow(String)
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getArrowOp_Arrow()
   * @model
   * @generated
   */
  String getArrow();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.ArrowOp#getArrow <em>Arrow</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
