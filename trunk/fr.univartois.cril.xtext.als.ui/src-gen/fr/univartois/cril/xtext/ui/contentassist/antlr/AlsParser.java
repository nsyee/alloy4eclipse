		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuleAccess().getModuleNameAssignment_0(), "rule__Module__ModuleNameAssignment_0");
					put(grammarAccess.getModuleAccess().getLeftAssignment_1_0(), "rule__Module__LeftAssignment_1_0");
					put(grammarAccess.getModuleAccess().getExactlyAssignment_1_1(), "rule__Module__ExactlyAssignment_1_1");
					put(grammarAccess.getModuleAccess().getNameAssignment_1_2(), "rule__Module__NameAssignment_1_2");
					put(grammarAccess.getModuleAccess().getCommaAssignment_1_3_0(), "rule__Module__CommaAssignment_1_3_0");
					put(grammarAccess.getModuleAccess().getExactlyAssignment_1_3_1(), "rule__Module__ExactlyAssignment_1_3_1");
					put(grammarAccess.getModuleAccess().getNumberAssignment_1_3_2(), "rule__Module__NumberAssignment_1_3_2");
					put(grammarAccess.getModuleAccess().getRightAssignment_1_4(), "rule__Module__RightAssignment_1_4");
