...
//		This log records diagnostic messages
		...
		for (Command cmd: world.getRootModule().getAllCommands()) {
			// Execute the command
			Console.printlnConsole("============ Command "+cmd+": ============\n",filename);
			A4Solution ans;
