...
public class AlsLabelProvider extends DefaultEObjectLabelProvider {
	...
	String text(Signature sig) {
		...
		for (SignatureName n : sig.getSignatureName().subList(1,
				sig.getSignatureName().size()))
			name += ", " + n.getName();
		return name;
	}
	...
	String image(SignatureName sig) {
		return "sig.gif";
	}
	...
	String image(AssertionName assertD) {
		return "assert.gif";
	}
	...
	String image(Predicate pred) {
		return "predicate.gif";
	}

	String image(PredicateName pred) {
		return "predicate.gif";
	}
	...
	String text(RunCommand run) {
		...
		if (run.getRunName() == null) {
			...
			for (Typescope t : s.getTypescope()) {
				if (t.getExactly() != null)
					sb.append(t.getExactly() + " ");
				sb.append(t.getValue() + " ");
				if (t.getAsname() != null)
					sb.append(t.getAsname().getName() + " ");
				if (t.getPrev() != null)
					sb.append(t.getPrev() + " ");
				if (t.getSl() != null)
					sb.append(t.getSl() + " ");
				if (t.getName() != null)
					sb.append(t.getName().getName() + " ");
				if (t.getPost() != null)
					sb.append(t.getPost() + " ");
