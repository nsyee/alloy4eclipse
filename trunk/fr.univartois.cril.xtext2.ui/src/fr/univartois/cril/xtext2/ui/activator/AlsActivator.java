...
import fr.univartois.cril.xtext2.preferences.PreferenceInitializer;
...
public class AlsActivator extends fr.univartois.cril.xtext2.ui.internal.AlsActivator {
	 ...
	 * The plug-in ID.
	 */
	public static final String PLUGIN_ID = "fr.univartois.cril.xtext2.alloyplugin";
	...
	private void copyFromJAR() {
		...
		Util.copy(
				...
				"models/book/chapter2/theme.thm",
