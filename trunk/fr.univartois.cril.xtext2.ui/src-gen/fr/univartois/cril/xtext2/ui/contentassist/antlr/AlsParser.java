		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTerminalExpressionAccess().getAlternatives_4_2(), "rule__TerminalExpression__Alternatives_4_2");
					...
					put(grammarAccess.getFactDeclAccess().getNameAssignment_0(), "rule__FactDecl__NameAssignment_0");
					...
					put(grammarAccess.getFunDeclAccess().getNameAssignment_3(), "rule__FunDecl__NameAssignment_3");
					put(grammarAccess.getFunDeclAccess().getLeftSAssignment_4_0_0(), "rule__FunDecl__LeftSAssignment_4_0_0");
					put(grammarAccess.getFunDeclAccess().getParamAssignment_4_0_1_0(), "rule__FunDecl__ParamAssignment_4_0_1_0");
					put(grammarAccess.getFunDeclAccess().getCommaAssignment_4_0_1_1_0(), "rule__FunDecl__CommaAssignment_4_0_1_1_0");
					put(grammarAccess.getFunDeclAccess().getParamAssignment_4_0_1_1_1(), "rule__FunDecl__ParamAssignment_4_0_1_1_1");
					...
					put(grammarAccess.getFunDeclWParamAccess().getNameAssignment_3(), "rule__FunDeclWParam__NameAssignment_3");
					...
					put(grammarAccess.getPredDeclAccess().getNameAssignment_3(), "rule__PredDecl__NameAssignment_3");
					put(grammarAccess.getPredDeclAccess().getLeftSAssignment_4_0_0(), "rule__PredDecl__LeftSAssignment_4_0_0");
					put(grammarAccess.getPredDeclAccess().getParamAssignment_4_0_1_0(), "rule__PredDecl__ParamAssignment_4_0_1_0");
					put(grammarAccess.getPredDeclAccess().getCommaAssignment_4_0_1_1_0(), "rule__PredDecl__CommaAssignment_4_0_1_1_0");
					put(grammarAccess.getPredDeclAccess().getParamAssignment_4_0_1_1_1(), "rule__PredDecl__ParamAssignment_4_0_1_1_1");
					...
					put(grammarAccess.getPredDeclAccess().getParamAssignment_4_1_1_0(), "rule__PredDecl__ParamAssignment_4_1_1_0");
					put(grammarAccess.getPredDeclAccess().getCommaAssignment_4_1_1_1_0(), "rule__PredDecl__CommaAssignment_4_1_1_1_0");
					put(grammarAccess.getPredDeclAccess().getParamAssignment_4_1_1_1_1(), "rule__PredDecl__ParamAssignment_4_1_1_1_1");
					...
					put(grammarAccess.getLetOutDeclAccess().getNameAssignment_0(), "rule__LetOutDecl__NameAssignment_0");
					...
					put(grammarAccess.getTerminalExpressionAccess().getExprAssignment_4_2_0(), "rule__TerminalExpression__ExprAssignment_4_2_0");
					put(grammarAccess.getTerminalExpressionAccess().getDeclAssignment_4_2_1_0(), "rule__TerminalExpression__DeclAssignment_4_2_1_0");
					put(grammarAccess.getTerminalExpressionAccess().getCommaAssignment_4_2_1_1_0(), "rule__TerminalExpression__CommaAssignment_4_2_1_1_0");
					put(grammarAccess.getTerminalExpressionAccess().getDeclAssignment_4_2_1_1_1(), "rule__TerminalExpression__DeclAssignment_4_2_1_1_1");
					put(grammarAccess.getTerminalExpressionAccess().getBlockOrBarAssignment_4_3(), "rule__TerminalExpression__BlockOrBarAssignment_4_3");
