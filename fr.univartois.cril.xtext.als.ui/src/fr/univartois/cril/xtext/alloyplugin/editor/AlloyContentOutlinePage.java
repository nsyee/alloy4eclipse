...
import fr.univartois.cril.xtext.alloyplugin.core.UnsatCorePos;
import fr.univartois.cril.xtext.alloyplugin.launch.ui.CloseAllView;
import fr.univartois.cril.xtext.alloyplugin.launch.ui.DisplayCommandAnswerAction;
import fr.univartois.cril.xtext.alloyplugin.launch.ui.LaunchCommandAction;
        ...
        public void selectionChanged(SelectionChangedEvent event) {
            ...
            if (selection instanceof IALSCommand) {
                ...
                boolean canShowCore = PreferenceConstants.V_SOLVER_MiniSatProverUnsatCore
                        .equals(AlsActivator.getDefault().getPreferenceStore()
