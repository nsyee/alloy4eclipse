...
public class AlsStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new fr.univartois.cril.xtext.AlsRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.univartois.fr/cril/xtext/Als")) {
		EPackage.Registry.INSTANCE.put("http://www.univartois.fr/cril/xtext/Als", fr.univartois.cril.xtext.als.AlsPackage.eINSTANCE);
	}
