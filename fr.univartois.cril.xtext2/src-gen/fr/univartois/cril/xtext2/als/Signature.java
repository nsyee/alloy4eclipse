 ...
 *   <li>{@link fr.univartois.cril.xtext2.als.Signature#getDecl <em>Decl</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Signature#getComma2 <em>Comma2</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Signature#getBlock <em>Block</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature()
 * @model
 * @generated
 */
public interface Signature extends Paragraph
{
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature_SignatureName()
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature_Comma()
   * @model containment="true"
   * @generated
   */
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature_SigExt()
   * @model containment="true"
   * @generated
   */
  SigExt getSigExt();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Signature#getSigExt <em>Sig Ext</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature_Decl()
   * @model containment="true"
   * @generated
   */
  EList<Decl> getDecl();
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature_Comma2()
   * @model unique="false"
   * @generated
   */
   ...
   * @see #setBlock(Block)
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getSignature_Block()
   * @model containment="true"
   * @generated
   */
  Block getBlock();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Signature#getBlock <em>Block</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
