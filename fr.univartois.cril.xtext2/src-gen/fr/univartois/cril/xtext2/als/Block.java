 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.Block#getLeftC <em>Left C</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Block#getExpr <em>Expr</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Block#getRightC <em>Right C</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getBlock()
 * @model
 * @generated
 */
public interface Block extends EObject
{
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getBlock_LeftC()
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Block#getLeftC <em>Left C</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getBlock_Expr()
   * @model containment="true"
   * @generated
   */
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getBlock_RightC()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Block#getRightC <em>Right C</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
