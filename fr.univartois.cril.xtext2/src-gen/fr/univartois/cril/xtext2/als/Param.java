 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.Param#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Param#getComma <em>Comma</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Param#getColon <em>Colon</em>}</li>
 *   <li>{@link fr.univartois.cril.xtext2.als.Param#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.univartois.cril.xtext2.als.AlsPackage#getParam()
 * @model
 * @generated
 */
public interface Param extends EObject
{
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getParam_PropertyName()
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getParam_Comma()
   * @model containment="true"
   * @generated
   */
   ...
   * @see #setColon(Colon)
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getParam_Colon()
   * @model containment="true"
   * @generated
   */
  Colon getColon();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Param#getColon <em>Colon</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getParam_Expr()
   * @model containment="true"
   * @generated
   */
  Expression getExpr();
  ...
  /**
   * Sets the value of the '{@link fr.univartois.cril.xtext2.als.Param#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
