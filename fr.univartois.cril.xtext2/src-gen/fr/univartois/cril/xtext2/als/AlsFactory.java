...
public interface AlsFactory extends EFactory
{
   ...
   * @generated
   */
  AlsFactory eINSTANCE = fr.univartois.cril.xtext2.als.impl.AlsFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Block Or Possible Bar</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Block Or Possible Bar</em>'.
   * @generated
   */
  BlockOrPossibleBar createBlockOrPossibleBar();
