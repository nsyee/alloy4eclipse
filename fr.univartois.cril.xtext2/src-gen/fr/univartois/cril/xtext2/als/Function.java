 ...
 * <ul>
 *   <li>{@link fr.univartois.cril.xtext2.als.Function#getDocumentation <em>Documentation</em>}</li>
...
public interface Function extends Paragraph
{
   ...
   * @see fr.univartois.cril.xtext2.als.AlsPackage#getFunction_Documentation()
   * @model unique="false"
   * @generated
   */
